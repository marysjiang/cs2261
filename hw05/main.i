...
extern ANISPRITE snake[26];
extern ANISPRITE oranges[24];
...
void goToStart() {
    ...
    DMANow(3, bgStartTiles, &((charblock *)0x6000000)[0], 2688 / 2);
...
void goToGame() {
    DMANow(3, bgGamePal, ((unsigned short *)0x5000000), 256);
    DMANow(3, bgGameTiles, &((charblock *)0x6000000)[0], 7552 / 2);
    DMANow(3, bgGameMap, &((screenblock *)0x6000000)[28], 2048 / 2);
...
void goToWin() {
    DMANow(3, bgWinPal, ((unsigned short *)0x5000000), 256);
    DMANow(3, bgWinTiles, &((charblock *)0x6000000)[0], 3712 / 2);
...
void goToLose() {
    ...
    DMANow(3, bgLoseTiles, &((charblock *)0x6000000)[0], 3808 / 2);
